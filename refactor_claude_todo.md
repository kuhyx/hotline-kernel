...
- **3 files** currently exceed 250 lines (of 36 eligible files).
- **1,145 lines** sit in violation; longest file is **422 lines**.
...
|------:|-----------:|:-----|:-----|
| 353 | 0 | code | `tests/components.test.tsx` |
| 370 | 0 | code | `tests/sim.test.ts` |
| 422 | 0 | code | `tests/tokens.test.ts` |
